...
#define cpu_map_h
  ...
  // Changed from Pin 6 (PH3) to Pin 53 (PB7) to avoid port conflicts with direction pins on PORTC
  #define SPINDLE_ENABLE_DDR      DDRB
  #define SPINDLE_ENABLE_PORT     PORTB
  #define SPINDLE_ENABLE_BIT      7 // MEGA2560 Digital Pin 53
  ...
  // PWM DISABLED - Using digital relay control only to avoid timer/port conflicts
  // Timer 4 configuration removed to prevent interference with PORTH
